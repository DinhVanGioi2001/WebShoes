 ...
 * @author Hung Dinh
 */
@WebServlet(name = "LoadMoreAjaxControl", urlPatterns = {"/loadMore"})
public class LoadMoreAjaxControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //tạm thời load 3 sản phẩm trước
        String temp = request.getParameter("exits");
